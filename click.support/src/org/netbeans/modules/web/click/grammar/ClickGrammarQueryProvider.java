 ...
 * @author hantsy
 */
public class ClickGrammarQueryProvider extends GrammarQueryManager {

    private final GrammarQuery grammar;
    
    public ClickGrammarQueryProvider() {
        grammar = DTDUtil.parseDTD(true,
                new InputSource(ClickCatalog.CLICK_2_1_DTD_LOCAL_URI));
    }
    ...
    public Enumeration enabled(GrammarEnvironment ctx) {
        ...
        while (en.hasMoreElements()) {
            ...
            if (next.getNodeType() == next.ELEMENT_NODE) {
                ...
                if ("click-app".equals(root.getNodeName())) { // NOI18N
