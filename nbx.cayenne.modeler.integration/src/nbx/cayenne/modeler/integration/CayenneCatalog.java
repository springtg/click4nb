...
public class CayenneCatalog implements CatalogReader, CatalogDescriptor, EntityResolver {
    ...
    private static final String CAYENNE_MODELMAP_XSD_LOCAL_URI = "nbres://nbx/cayenne/modeler/integration/resource/modelMap.xsd";
    ...
    public Image getIcon(int arg0) {
        return ImageUtilities.loadImage("/nbx/cayenne/integration/resource/cayenne.png");
    }
